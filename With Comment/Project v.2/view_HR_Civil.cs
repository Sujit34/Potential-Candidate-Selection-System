...
{
    public partial class view_HR_Civil : Form
    {
        public view_HR_Civil()
        {
            InitializeComponent();
        }
        ...
        {
            this.Hide();
            Admin_arena_civil goadcivil = new Admin_arena_civil();
            goadcivil.Show();
        }

        //show data
        private void Show_hr_Click(object sender, EventArgs e)
        {
            try
            {
